...
class DockerClient(
    ...
    private val containerRecreator = ContainerRecreator(client)
    ...
    fun recreateContainer(
        containerId: String,
        pull: ContainerRecreator.ImagePull?,
        listener: ContainerRecreator.Listener
    ): ContainerRecreator.Result {
        return containerRecreator.recreate(containerId, pull, listener)
    }
