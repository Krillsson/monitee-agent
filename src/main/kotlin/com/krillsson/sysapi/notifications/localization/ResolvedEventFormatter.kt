    ...
    fun formatResolvedEventTitle(
        ...
        return with(notification) {
            when (monitorType) {
                ...
                Monitor.Type.STORAGE_POOL_HEALTH -> "Storage pool healthy again on $serverName"
    ...
    fun formatResolvedEventDescription(
        ...
        return with(notification) {
            ...
            return when (monitorType) {
                ...
                Monitor.Type.STORAGE_POOL_HEALTH -> "Pool $monitoredItemId is back to $formattedValue after $formattedDuration"
