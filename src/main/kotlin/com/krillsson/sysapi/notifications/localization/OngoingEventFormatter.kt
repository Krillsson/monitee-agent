    ...
    fun formatOngoingEventTitle(
        ...
        return with(notification) {
            when (monitorType) {
                ...
                Monitor.Type.STORAGE_POOL_HEALTH -> "Storage pool degraded on $serverName"
    ...
    fun formatOngoingEventDescription(
        ...
        return with(notification) {
            ...
            return when (monitorType) {
                ...
                Monitor.Type.STORAGE_POOL_HEALTH -> "Pool $monitoredItemId went above $formattedThreshold to $formattedValue"
